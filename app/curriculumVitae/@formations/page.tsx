  ...
  return (
    <Card>
      ...
      <CardContent>
        <Label>
          <HoverCardFormation
            options={{
              ...
              avatar:
                "https://cdn.ent.auvergnerhonealpes.fr/images/favicon.ico",
              footer: "Ici on fait du fromage - et c'est déjà pas mal",
            }}
          />
          - Gestion et Communication en entreprise
        </Label>
        <CardDescription>Optenu en 2007</CardDescription>
        <Label>
          <HoverCardFormation
            options={{
              title: "Bioforce",
              ...
              avatar:
                "https://www.bioforce.org/wp-content/uploads/2020/05/favicon.png",
        ...
        <CardDescription>
          Evaluation continue et ecris valider - Mémoire de terrain mis en
          attente
        </CardDescription>
        <Label>
          <HoverCardFormation
        ...
        <CardDescription>Optenu en 2022</CardDescription>
      </CardContent>
    </Card>
  );
}
