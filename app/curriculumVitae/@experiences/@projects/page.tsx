        ...
        <CarouselItem className="">
          <div className="justify-start grid md:grid-flow-row auto-rows-min">
            ...
            <div className="flex flex-col justify-center items-start">
              Affichage des chariots terminés
              <CardDescription></CardDescription>
              <CardDescription>
                adaptation d&apos;un script tamper monkey
              </CardDescription>
            </div>
            <CardDescription>
        ...
        <CarouselItem>
          <div className="justify-start grid md:grid-flow-row auto-rows-min">
            ...
            <div className="flex flex-col justify-center items-start">
              ...
              <CardDescription>
                Réduit l&apos;utilisation des sites annexes
              </CardDescription>
            ...
            <CardDescription>
              <ul className="px-5 list-disc">
                <li>
                  Affiche l&apos;équivalent de 3 pages d&apos;informations en
                  une
                </li>
                <li>
                  Ajoute des informations utile récupérer sur des API tiers
                </li>
                <li>
                  Aide les responsables de zone à maitriser le prélèvement dans
                  les temps impartis.
                </li>
                <li>
                  Améliore la réactivité et la disponibilité des responsables
                  sur le terrain
                </li>
              </ul>
            </CardDescription>
