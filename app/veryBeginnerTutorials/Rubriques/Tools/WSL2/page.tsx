      ...
      <Card>
        <CardHeader>
          ...
          <div className="mt-2 text-muted-foreground text-sm">
            <b>Alternative:</b> You can install WSL2 with a single command
            (Windows 10 21H2+ or Windows 11):
            <pre className="bg-muted mt-2 p-3 rounded overflow-x-auto text-sm">
              <code>wsl --install</code>
            </pre>
            This command enables all required features and installs Ubuntu by
            default.
          </div>
        </CardHeader>
          ...
          <ol className="space-y-4 list-decimal list-inside">
            <li>
              ...
              <div className="text-muted-foreground text-sm">
                Right-click the Start button &rarr;{" "}
            ...
            <li>
              ...
              <div className="text-muted-foreground text-sm">
                Open Microsoft Store, search for <b>Ubuntu</b> (or your
                preferred distro), and install it.
              </div>
            </li>
            <li>
              <span className="font-semibold">
