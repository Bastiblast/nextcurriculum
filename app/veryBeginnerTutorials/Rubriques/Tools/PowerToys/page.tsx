        ...
        <div className="mx-auto mt-10 max-w-xl">
            <Card>
                ...
                <CardContent>
                    ...
                    <h3 className="mb-2 font-semibold">How to Install PowerToys with Windows Package Manager</h3>
                    <ol className="space-y-1 mb-4 list-decimal list-inside">
                        <li>
                            Open <span className="bg-muted px-1 py-0.5 rounded font-mono">Windows Terminal</span> or <span className="bg-muted px-1 py-0.5 rounded font-mono">Command Prompt</span>.
                        </li>
                        <li>
                    ...
                    <ul className="space-y-2 list-disc list-inside">
                        ...
                        <li>
                            <strong>Import/Export Settings:</strong> Share your keyboard configurations with others or use them on different machines.
                                                ...
                                                <li>
                            <strong>/!\ Past in prompt password /!\</strong> Be sure that youre terminal have recent update.
                        </li>
                    </ul>
                </CardContent>
            </Card>
