...
const copyCutPasteCommands = [
  {
    command: "yy / dd",
    description: "Copy (yank) / Cut (delete) current line",
  },
...
const advancedUsage = [
  {
    ...
    description: "Split window horizontally / vertically",
  },
  ...
  {
    command: "Visual Mode (v, V, Ctrl+v)",
    description: "Select by character, line, or block",
  },
];
      ...
      <Card>
        ...
        <CardContent>
          <p className="mb-4 text-muted-foreground">
            <strong>VIM</strong> is a powerful text editor available on most
            Linux systems. It is highly efficient for editing code and
            configuration files, offering both basic and advanced features for
            navigation, editing, and automation.
          </p>
